  ...
  <div class="form-group row">
    ...
    <div class="col-6">
      <select id="unit_kerja_id" name="unit_kerja_id" class="custom-select">
        <option value="1" selected>Puskesmas Merdeka</option>
        <option value="2">Puskesmas Kayu Manis</option>
        <option value="3">Puskesmas Bogor Timur</option>
        <option value="4">Puskesmas Gang Kelor</option>
        <option value="5">Puskesmas Mulyaharja</option>
        <option value="2">Puskesmas Nanggung</option>
        <option value="3">Puskesmas Puraseda</option>
        <option value="3">Puskesmas Leuwisadeng</option>
      </select>
    </div>
  </div> 
  <div class="form-group row">
