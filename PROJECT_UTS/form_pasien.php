  ...
  <div class="form-group row">
    ...
    <div class="col-6">
      <select id="kelurahan_id" name="kelurahan_id" class="custom-select">
        <option value="1" selected>Cilebut</option>
        <option value="2">Citayam</option>
        <option value="3">Bojong Gede</option>
        <option value="4">Kebun Pedas</option>
        <option value="5">Atangsanjaya</option>
        <option value="2">Kemang</option>
        <option value="3">Ciawi</option>
