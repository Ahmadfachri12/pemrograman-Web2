...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a href="dex.php" class="navbar-brand p-0">
        <h1 class="m-0 text-primary"><i class="fa fa-tooth me-2"></i>Puskesmas Pabuaran </h1>
      </a>
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a href="dex.php" class="nav-link">Home</a>
  ...
  <div class="form-group row">
    ...
    <div class="col-6">
      <select id="dokter_id" name="dokter_id" class="custom-select">
        <option value="2">Ahmad Fachri</option>
        <option value="3">fahri</option>
        <option value="4">Ahmad</option>
        <option value="5">Setiawan</option>
      </select>
    </div>
  </div> 
  <div class="form-group row">
